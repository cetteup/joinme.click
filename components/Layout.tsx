...
const Footer: FC = () => {
    return (
        <footer className='mt-4'>
            <p className={'fs-5 text-white-50'}><small>Need help? Join <a href={'https://discord.gg/66u9udBF57'} className="text-white-50">our Discord</a></small></p>
            <div className={'fs-4'}>
                <IconLink icon={'bi-discord'} href={'https://discord.gg/66u9udBF57'} title={'Join our Discord'} />
